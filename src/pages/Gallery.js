...
import smallLondonEye from "../images/london-eye_640.jpg";
import mediumLondonEye from "../images/london-eye_1280.jpg";
import largeLondonEye from "../images/london-eye_1920.jpg";
import smallStonehenge from "../images/stonehenge_640.jpg";
import mediumStonehenge from "../images/stonehenge_1280.jpg";
import largeStonehenge from "../images/stonehenge_1920.jpg";
import smallWembley from "../images/wembley_640.jpg";
import mediumWembley from "../images/wembley_1280.jpg";
import largeWembley from "../images/wembley_1920.jpg";
import smallBullTerrier from "../images/english-bull-terrier_640.jpg";
import mediumBullTerrier from "../images/english-bull-terrier_1280.jpg";
import largeBullTerrier from "../images/english-bull-terrier_1920.jpg";
...
class Gallery extends Component {
    ...
    static defaultProps = {
        ...
        mediumImages: [mediumBullTerrier, mediumLondonEye, mediumStonehenge, mediumWembley],
    ...
    render() {
        ...
        const { smallImages, mediumImages, largeImages, translations } = this.props;
            ...
            <div className="galleryWrapper">
                <div className="gallery">
                    <div className="gallery__container">
                        <picture>
                            <source media="(max-width: 640px)" srcset={smallImages[index]} />
                            <source media="(max-width: 1280px)" srcset={mediumImages[index]} />
                            <source media="(max-width: 1920px)" srcset={largeImages[index]} />
                            <img className="gallery__img" src={largeImages[index]} alt="England related photos" />
                        </picture>
                    </div>
